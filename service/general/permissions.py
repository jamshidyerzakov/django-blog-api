...
_DEFAULT_PERMISSIONS = {
    'GET': (IsAuthenticatedOrReadOnly,),  # (AllowAny,),
    'POST': (IsAuthenticated,),  # (AllowAny,),
    'PUT': (IsAuthenticated, IsOwnerOrAdmin),  # (AllowAny,),
    'PATCH': (IsAuthenticated, IsOwnerOrAdmin),  # (AllowAny,),
    'DELETE': (IsAuthenticated, IsStaff,),  # (AllowAny,),
}
